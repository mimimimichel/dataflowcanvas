...
import { PipelineNode, JoinOperation as JoinOperationType, JoinType, Field } from '@/lib/pipeline-data';
...
const JoinOperationEditor: React.FC<JoinOperationEditorProps> = ({ operation, leftNode, rightNode, onUpdate }) => {
  ...
  return (
    <div className="space-y-4">
      <div className="grid w-full items-center gap-1.5">
        ...
        <Select
          value={operation.settings.joinType}
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="grid w-full items-center gap-1.5">
          ...
          <Select
            value={operation.settings.condition.leftField}
        ...
        <div className="grid w-full items-center gap-1.5">
          ...
          <Select
            value={operation.settings.condition.rightField}
